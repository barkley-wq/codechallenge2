...
function buildToDo(todo){
    ...
    p.appendChild(btn);
    p.appendChild(butn);
    button1.addEventListener("click",markPurchased)//call back function to handle the event where item has been purchased
    button2.addEventListener('click',handleDelete)//callback function for deleting item from list
